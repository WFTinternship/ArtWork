...
//
//import am.aca.wftartproject.repository.UserDao;
...
//
//        // Setup mocks
//        doThrow(DAOException.class).when(userDaoMock).updateUser(any(User.class));
//
//        // Test method
//        userService.updateUser(testUser);
//    }
...
//
//        // Setup mocks
//        doReturn(true).when(userDaoMock).updateUser(argumentCaptor.capture());
//
//        // Test method
//        userService.updateUser(testUser);
//
...
//        testUser = createTestUser();
//        testUser.setId(5L);
//        doThrow(DAOException.class).when(userDaoMock).deleteUser(any(User.class));
//
//        // Test method
//        userService.deleteUser(testUser);
//    }
