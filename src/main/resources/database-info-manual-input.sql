...
INSERT INTO item(title,description,photo_url,price,artist_id,status,type) VALUES('Title 1','Test Desc 1','../../resources/images/product/art-deco-600x600.jpg',100,1,0,'SCULPTURE');
INSERT INTO item(title,description,photo_url,price,artist_id,status,type) VALUES('Title 2','Test Desc 2','../../resources/images/product/art-deco-600x600.jpg',250,1,0,'PHOTOGRAPHY');
INSERT INTO item(title,description,photo_url,price,artist_id,status,type) VALUES('Title 3','Test Desc 3','../../resources/images/product/art-deco-600x600.jpg',450,1,0,'PAINTING');
INSERT INTO item(title,description,photo_url,price,artist_id,status,type) VALUES('Title 4','Test Desc 4','../../resources/images/product/art-deco-600x600.jpg',50,1,0,'OTHER');
INSERT INTO item(title,description,photo_url,price,artist_id,status,type) VALUES('Title 5','Test Desc 5','../../resources/images/product/art-deco-600x600.jpg',180,2,0,'PHOTOGRAPHY');
INSERT INTO item(title,description,photo_url,price,artist_id,status,type) VALUES('Title 6','Test Desc 6','../../resources/images/product/art-deco-600x600.jpg',1000,2,0,'SCULPTURE');
INSERT INTO item(title,description,photo_url,price,artist_id,status,type) VALUES('Title 7','Test Desc 7','../../resources/images/product/art-deco-600x600.jpg',300,3,0,'PAINTING');
INSERT INTO item(title,description,photo_url,price,artist_id,status,type) VALUES('Title 8','Test Desc 8','../../resources/images/product/art-deco-600x600.jpg',560,5,0,'OTHER');
