...
/**
 * Created by Armen on 7/20/2017.
 */
public class EmailSender {
    private static final String EMAIL = "workfront.internship@gmail.com";
    private static final String PASSWORD = "project2017";

    public static void sendEmail(AbstractUser abstractUser, String subject, String mailText) throws javax.mail.MessagingException {
