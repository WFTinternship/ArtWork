...
<div class="wrapper">
    <div class="inner-wrapper">
        <div id="header-wrapper" class="dt-sticky-menu"> <!-- **header-wrapper Starts** -->
            ...
            <%--&lt;%&ndash;<li><a href="item-detail.jsp">Shop Detail</a></li>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li><a href="shop-cart.jsp">Cart Page</a></li>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li><a href="shop-checkout.html">Checkout Page</a></li>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<a class="dt-menu-expand">+</a>                    &ndash;%&gt;--%>
            <%--</li>--%>
            <%--&lt;%&ndash;<li class="menu-item-simple-parent"><a href="blog.html">Blog <span class="fa fa-pencil-square-o"></span></a>--%>
            <%--<ul class="sub-menu">--%>
            ...
            <%--</li>--%>
            <%--<li class="menu-item-simple-parent">--%>
            <%--<a href="&lt;%&ndash;progressbar.html&ndash;%&gt;">Account&lt;%&ndash;shortcodes&ndash;%&gt; <span class="fa fa-paint-brush"></span></a>--%>
            <%--<ul class="sub-menu">--%>
            <%--&lt;%&ndash;<li><a href="progressbar.html"> Progress-bar </a></li>--%>
            <%--<li><a href="buttons.html"> Buttons Page </a></li>--%>
            <%--<li><a href="tabs.html"> tabs-accordions </a></li>--%>
            <%--<li><a href="typography.html"> typography </a></li>--%>
            <%--<li><a href="columns.html"> columns </a></li>&ndash;%&gt;--%>
            ...
            <section id="primary" class="content-full-width"> <!-- **Primary Starts Here** -->
                <div class="container">
                    ...
                    <div class="dt-sc-service-content">
                        ...
                        <p class="lead"><strong>Please check your email</strong> for further instructions on how to get
                            the item.</p>
                        <hr>
                        <p>
                    ...
                    <div class="service-grid">
                        ...
                        <%--<div class="dt-sc-ico-content animate" data-animation="fadeInRight"--%>
                        <%--data-delay="100">--%>
                        <%--<h6>About Me</h6>--%>
                        ...
                        <%--<p>Lorem ipsum dolor sit amet elit elit elit elit, consectetur adipiscing elit,--%>
                        <%--sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>--%>
                        <%--</div>--%>
                        <%--</div>--%>
                        <%--<div class="dt-sc-one-half column dt-sc-icon-wrapper">--%>
                        <%--<div class="dt-sc-icon"><i class="fa fa-user-secret animate"--%>
                        <%--data-animation="fadeInLeft" data-delay="100"></i></div>--%>
                        <%--</div>--%>
                        <%--</div><!-- *dt-sc-icon-content-wrapper Ends here** -->--%>
                        <%--</div>--%>
                        <%--<div class="dt-sc-one-half column">--%>
                        <%--<div class="dt-sc-icon-content-wrapper left">--%>
                        <%--<!-- *dt-sc-icon-content-wrapper Starts here** -->--%>
                        <%--<div class="dt-sc-one-half column first dt-sc-icon-wrapper">--%>
                        <%--<div class="dt-sc-icon"><i class="fa fa-paint-brush animate"--%>
                        <%--data-animation="fadeInRight" data-delay="100"></i></div>--%>
                        <%--</div>--%>
                        <%--<div class="dt-sc-one-half column">--%>
                        ...
                        <%--</div>--%>
                        <%--<div class="dt-sc-one-half column dt-sc-icon-wrapper">--%>
                        <%--<div class="dt-sc-icon"><i class="fa fa-whatsapp animate"--%>
                        <%--data-animation="fadeInLeft" data-delay="100"></i></div>--%>
                        <%--</div>--%>
                        <%--</div><!-- *dt-sc-icon-content-wrapper Ends here** -->--%>
                        <%--</div>--%>
